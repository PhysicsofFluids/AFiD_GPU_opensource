...
!====================================================================
      ...
      real(fp_kind), dimension(sz), intent(in) :: var
      integer(HID_T) :: file_id
      integer(HID_T) :: dset, filespace
      integer :: hdf_error
      integer(HSIZE_T) :: dims(1)
...
!====================================================================
      ...
      character*30,intent(in) :: dsetname,filename
      integer, intent(in) :: sz
      real(fp_kind), dimension(sz), intent(out) :: var
      integer(HID_T) :: file_id
      integer(HID_T) :: dset
      integer :: hdf_error
      integer(HSIZE_T) :: dims(1)
...
!====================================================================
      ...
      real(fp_kind), intent(out), dimension(1:n3o,st2-lvlhalo:en2+lvlhalo, &
...
!====================================================================
      ...
      real(fp_kind), intent(in), dimension(1:nx, &
