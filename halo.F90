...
!=======================================================================
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  subroutine update_halo_real_cpu(in, level)
...
#include "halo_common.F90"
    ...
    return
  end subroutine update_halo_real_cpu

#ifdef USE_CUDA
subroutine update_halo_real_gpu(in, level)

    implicit none

    integer, intent(IN) :: level      ! levels of halo cells required
    real(mytype),device,  dimension(:,:,:), intent(INOUT) :: in
...
#include "halo_common_gpu.F90"

    return
  end subroutine update_halo_real_gpu
#endif
